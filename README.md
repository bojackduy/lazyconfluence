...
- Terminal image previews for cached Confluence PNG and JPEG attachments plus safely rasterized SVGs, without requiring Kitty, Sixel, or iTerm image protocols.
