...
- Search, spaces, and link overlays are partial: active-space page search and space switcher read the local SQLite index, page search follows the active Current/Archived navigator tab, and current-page search includes staged local creates; document find, all-space search UI, command palette, help, and link navigation overlays remain.
