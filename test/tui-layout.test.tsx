...
describe("main TUI layout", () => {
  ...
  test("focus keys keep h/l document-local and cycle all panes", () => {
    ...
    expect(nextFocusPaneForKey("document", key("h", "h"))).toBe("outline")
    expect(nextFocusPaneForKey("document", key("left", "\x1B[D"))).toBe("document")
    expect(nextFocusPaneForKey("navigator", key("h", "h"))).toBe("document")
    expect(nextFocusPaneForKey("navigator", key("l", "l"))).toBe("related")
    expect(nextFocusPaneForKey("related", key("h", "h"))).toBe("navigator")
    expect(nextFocusPaneForKey("related", key("l", "l"))).toBe("outline")
