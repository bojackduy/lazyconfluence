...
describe("main TUI layout", () => {
  ...
  test("Tab and l cycle forward while Shift+Tab and h cycle backward", () => {
    ...
    expect(nextFocusPaneForKey("document", key("l", "l"))).toBe("outline")
    ...
    expect(nextFocusPaneForKey("related", key("l", "l"))).toBe("navigator")
    expect(nextFocusPaneForKey("related", key("h", "h"))).toBe("outline")
